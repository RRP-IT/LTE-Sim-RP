 ...
 *
 * Author of original file: Francesco Capozzi <f.capozzi@poliba.it>
...
static void SingleCellWithFemtoWithRiuso (double radius, int nbBuildings, int buildingType, double activityRatio,
  ...
  for (int i = 0; i < nbCell; i++)
    {
	  ...
	  std::cout << "Created Cell,  int cluster_enb=1; id " << c->GetIdCell ()
...
/* Made by Rui R. Paulo, please cite  doi: 10.1109/VTCFall.2018.8690935 */
  ...
  std::vector <BandwidthManager*> zx = RunFrequencyReuseTechniques (femtoCellsInBuilding, cluster_henb, bandwidth_henb);
